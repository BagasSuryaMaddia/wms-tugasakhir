...
import TambahBahanMasukComponent from "./components/item/TambahBahanMasukComponent";
import ViewItems from "./components/item/list-item.component";
import UpdateItems from "./components/item/update-item.component";
import TambahBahanKeluar from "./components/item/TambahBahanKeluar";
import TambahBahanKeluarComponent from "./components/item/TambahBahanKeluarComponent";
...
import StokBahanComponent from "./components/item/StokBahanComponent";
                ...
                >
                  <div className="container d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 mt-3 border-bottom">
                    <Switch>
                      ...
                      <Route path="/add-item" component={TambahBahanMasukComponent} />
                      <Route path="/view-items" component={ViewItems} />
                      <Route path="/update-items/:item_no" component={UpdateItems} />
                      <Route path="/add-service" component={TambahBahanKeluar} />
                      <Route path="/view-services" component={TambahBahanKeluarComponent} />
                      ...
                      <Route path="/stok-bahan" component={StokBahanComponent} />
                    </Switch>
                  </div>
                </main>
              </div>
