            ...
            <li className="nav-item">
              ...
              {currentUser && (
                <Link
                  ...
                  className={
                    "nav-link " +
                    (99 === this.state.currentIndex ? "active" : "")
                  }
                  onClick={() => this.setActiveItem(99)}
                >
              ...
              {showStudentBoard && (
                <div>
                  <div className="mt-4 mb-0 text-primary">
                    <h6>
                      <i className="fas fa-caret-right fa-fw"></i>Manajemen Data
                      Bahan
                    </h6>
                    <hr />
                  </div>
                  ...
                  >
                    <i className="fas fa-folder fa-fw"></i> Bahan Masuk
                  </Link>
                </div>
              )}
              ...
              {showStudentBoard && (
                ...
                >
                  <i className="fas fa-box fa-fw"></i> Data Stok Bahan
                </Link>
              )}
              ...
              {showStudentBoard && (
                <Link
                  ...
                  onClick={() => this.setActiveItem(3)}
                >
                  <i className="fas fa-folder fa-fw"></i> Bahan Keluar
                </Link>
              )}
              ...
              {showAcademicBoard && (
                <div>
                  <div className="mt-4 mb-0 text-info">
                    <h6>
                      <i className="fas fa-caret-right fa-fw"></i>Items &
                      Services
                    </h6>
                    <hr />
                  </div>
              ...
              {showAcademicBoard && (
                <div>
                  <div className="mt-4 mb-0 text-info">
                    <h6>
                      <i className="fas fa-caret-right fa-fw"></i>Requests
                    </h6>
                    <hr />
                  </div>
                  <Link
                    ...
                    className={
                      "nav-link " +
                      (7 === this.state.currentIndex ||
                      71 === this.state.currentIndex ||
                      72 === this.state.currentIndex
                        ? "active"
                        : "")
                    }
                    onClick={() => this.setActiveItem(7)}
                    data-toggle="collapse"
                    data-target="#collapseReq"
                    aria-expanded="false"
                  ...
                  <div className="collapse sub-menu" id="collapseReq">
                    <Link
                      to={"/approve/item-requests"}
                      className={
                        "nav-link " +
                        (71 === this.state.currentIndex ? "active" : "")
                      }
                      onClick={() => this.setActiveItem(71)}
                    >
                      <i className="fas fa-angle-right fa-fw"></i> Component
                      Requests
                    </Link>
                    <Link
                      to={"/approve/service-requests"}
                      className={
                        "nav-link " +
                        (72 === this.state.currentIndex ? "active" : "")
                      }
                      onClick={() => this.setActiveItem(72)}
                    >
                      <i className="fas fa-angle-right fa-fw"></i> Service
                      Requests
                    </Link>
                  </div>
                </div>
              ...
              {showNonacBoard && (
                <div>
                  ...
                  <Link
                    ...
                    className={
                      "nav-link " +
                      (12 === this.state.currentIndex ||
                      121 === this.state.currentIndex ||
                      122 === this.state.currentIndex
                        ? "active"
                        : "")
                    }
                    ...
                    aria-controls="collapseReq"
                  >
                    <i className="fas fa-chalkboard-teacher fa-fw"></i> Academic
                    Requests
                  </Link>
                  <div className="collapse sub-menu" id="collapseReq">
                    <Link
                      ...
                      className={
                        "nav-link " +
                        (121 === this.state.currentIndex ? "active" : "")
                      }
                      onClick={() => this.setActiveItem(121)}
                    >
                      <i className="fas fa-angle-right fa-fw"></i> Component
                      Requests
                    </Link>
                    <Link
                      to={"/proceed/service/ac"}
                      className={
                        "nav-link " +
                        (122 === this.state.currentIndex ? "active" : "")
                      }
                      onClick={() => this.setActiveItem(122)}
                    >
                      <i className="fas fa-angle-right fa-fw"></i> Service
                      Requests
                    </Link>
              ...
              {showNonacBoard && (
                <div>
                  <Link
                    ...
                    className={
                      "nav-link " +
                      (80 === this.state.currentIndex ||
                      801 === this.state.currentIndex ||
                      802 === this.state.currentIndex
                        ? "active"
                        : "")
                    }
                    onClick={() => this.setActiveItem(80)}
                    data-toggle="collapse"
                    data-target="#collapseReq2"
                    aria-expanded="false"
                    aria-controls="collapseReq2"
                  >
                    <i className="fas fa-book-reader fa-fw"></i> Student
                    Requests
                  </Link>
                  <div className="collapse sub-menu" id="collapseReq2">
                    <Link
                      ...
                      className={
                        "nav-link " +
                        (801 === this.state.currentIndex ? "active" : "")
                      }
                      onClick={() => this.setActiveItem(801)}
                    >
                      <i className="fas fa-angle-right fa-fw"></i> Component
                      Requests
                    </Link>
                    <Link
                      ...
                      className={
                        "nav-link " +
                        (802 === this.state.currentIndex ? "active" : "")
                      }
                      onClick={() => this.setActiveItem(802)}
                    >
                      <i className="fas fa-angle-right fa-fw"></i> Service
                      Requests
                    </Link>
              ...
              {currentUser && (
                <div>
                  <div className="mt-4 mb-0 text-info">
                    <h6>
                      <i className="fas fa-caret-right fa-fw"></i>Profile
                    </h6>
                    <hr />
                  </div>
                  <Link
                  ...
                  >
                    ...
                    {currentUser?.profile?.fulfillmentValue
                      ? currentUser?.profile?.fulfillmentValue?.first_name +
                        " " +
                        currentUser?.profile?.fulfillmentValue?.last_name
                      : "Admin"}
                  </Link>
                </div>
              )}
